...
* [anoma/juvix](https://github.com/anoma/juvix) - A more elegant language for a more civilized age.
...
* [zyla/haskell-nullpointer](https://github.com/zyla/haskell-nullpointer) - NullPointerExceptions in Haskell
...
* [jules-hedges/open-games-hs](https://github.com/jules-hedges/open-games-hs) - Haskell implementation of open games
...
* [typeable/octopod](https://github.com/typeable/octopod) - 🐙🛠️ Open-source self-hosted solution for managing multiple deployments in a Kubernetes cluster with a user-friendly web interface.
...
* [haskell/mwc-random](https://github.com/haskell/mwc-random) - A very fast Haskell library for generating high quality pseudo-random numbers.
...
* [unrelentingtech/pcre-heavy](https://github.com/unrelentingtech/pcre-heavy) - A Haskell regular expressions library that doesn't suck
...
* [neongreen/haskell-ex](https://github.com/neongreen/haskell-ex) - (ARCHIVED) Haskell exercises I wrote for Haskell Learning Group
...
* [arrayfire/arrayfire-haskell](https://github.com/arrayfire/arrayfire-haskell) - Haskell bindings to ArrayFire
...
* [anomanetwork/juvix](https://github.com/anomanetwork/juvix) - A more elegant language for a more civilized age.
...
* [dfithian/th-tutorial](https://github.com/dfithian/th-tutorial) - Template Haskell Workshop
...
* [liamoc/latex-formulae](https://github.com/liamoc/latex-formulae) - Libraries and tools for rendering math to images using real LaTeX, from Haskell, Pandoc and Hakyll
* [maoe/influxdb-haskell](https://github.com/maoe/influxdb-haskell) - InfluxDB client library for Haskell
...
* [thma/ThreepennyElectron](https://github.com/thma/ThreepennyElectron) - Demo for using Threepenny GUI together with Electron to create a portable Desktop GUI Application in Haskell
* [pkamenarsky/knit](https://github.com/pkamenarsky/knit) - Ties the knot on data structures that reference each other by unique keys
* [yogsototh/learn_haskell](https://github.com/yogsototh/learn_haskell) - An attemps to make a document to help learn Haskell
* [vmchale/madlang](https://github.com/vmchale/madlang) - Madlang is a language for generative literature
* [slyrz/hase](https://github.com/slyrz/hase) - Haskell bindings for the Senna NLP toolkit
* [serokell/o-clock](https://github.com/serokell/o-clock) - :hourglass: Type-safe time units in Haskell
...
* [ConferOpenSource/composite](https://github.com/ConferOpenSource/composite) - Integrations with Vinyl/Frames records.
...
* [alanz/lsp](https://github.com/alanz/lsp) - Haskell library for the Microsoft Language Server Protocol
...
* [dfithian/th-workshop](https://github.com/dfithian/th-workshop) - Template Haskell Workshop
...
* [metastatedev/juvix](https://github.com/metastatedev/juvix) - A more elegant language for a more civilized age.
* [myfreeweb/magicbane](https://github.com/myfreeweb/magicbane) - A web framework that integrates Servant, EKG, fast-logger, wai-cli…
* [haskell-Z/stdio](https://github.com/haskell-Z/stdio) - Haskell Standard Input and Output
...
* [aesiniath/http-streams](https://github.com/aesiniath/http-streams) - Haskell HTTP client library for use with io-streams
...
* [Mesabloo/nihil](https://github.com/Mesabloo/nihil) - Nothing to see here.
* [istathar/http-streams](https://github.com/istathar/http-streams) - Haskell HTTP client library for use with io-streams
...
* [soywod/unfog.cli](https://github.com/soywod/unfog.cli) - ⏱ Minimalist task & time manager, written in Haskell.
* [mn416/blarney](https://github.com/mn416/blarney) - Hardware description in Haskell
...
* [unfog-io/unfog-cli](https://github.com/unfog-io/unfog-cli) - ⏱ A simple task & time manager, written in Haskell.
...
* [Lemmih/reanimate](https://github.com/Lemmih/reanimate) - Haskell library for building declarative animations based on SVG graphics
* [srid/neuron](https://github.com/srid/neuron) - Haskell meets Zettelkasten, for your plain-text delight.
