...
* [effectfully/haskell-challenges](https://github.com/effectfully/haskell-challenges) - Code challenges to solve with Haskell
...
* [2178309/wisp](https://github.com/2178309/wisp) - small-but-featureful embeddable lisp interpreter written in haskell.
...
* [re-xyr/cleff](https://github.com/re-xyr/cleff) - Fast and concise effect handlers
...
* [IFCA-Advanced-Computing/opencl](https://github.com/IFCA-Advanced-Computing/opencl) - Haskell high-level wrapper for OpenCL
...
* [sayo-hs/heftia](https://github.com/sayo-hs/heftia) - higher-order algebraic effects done right for Haskell
* [AtifChy/xmonad](https://github.com/AtifChy/xmonad) - my Xmonad configuration
* [matthunz/aztecs](https://github.com/matthunz/aztecs) - A type-safe and friendly ECS for Haskell
...
* [chrisdone/tryhaskell](https://github.com/chrisdone/tryhaskell) - Try Haskell
...
* [Frost-Lord/HaskMate](https://github.com/Frost-Lord/HaskMate) - HaskMate is a Haskell-based project monitoring and automation tool designed to continuously watches for changes in your Haskell source files and automatically triggers a rebuild and re-execution of the project whenever a modification is detected.
...
* [razvan-flavius-panda/haskell-editor-setup](https://github.com/razvan-flavius-panda/haskell-editor-setup) - Easy instructions for setting up Haskell editors / IDEs on any major operating system.
...
* [fizruk/rzk](https://github.com/fizruk/rzk) - An experimental proof assistant based on a type theory for synthetic ∞-categories.
* [ed-o-saurus/PLHaskell](https://github.com/ed-o-saurus/PLHaskell) - A Haskell extension for PostgreSQL that allows embedded Haskell code.
