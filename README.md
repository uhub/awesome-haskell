...
* [digitallyinduced/ihp](https://github.com/digitallyinduced/ihp) - λ IHP is a modern batteries-included Web Framework, built on top of Haskell and Nix.
...
* [Bodigrim/smallcheck](https://github.com/Bodigrim/smallcheck) - smallcheck: test your Haskell code by exhaustively checking its properties
...
* [soywod/unfog](https://github.com/soywod/unfog) - ⏱ Minimalist task & time manager, written in Haskell.
...
* [scarf-sh/scarf](https://github.com/scarf-sh/scarf) - A cross platform package manager that helps open-source developers distribute and monetize their software
